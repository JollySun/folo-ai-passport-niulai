...
MIT © 2026 FoloToy。详见 [LICENSE](LICENSE)。
...
本仓库同时面向 AI agent 与人类开发者。编码、验证与提交规则见 [AGENTS.md](AGENTS.md)，完整硬件上下文见 [AI 硬件开发指南](docs/AI_HARDWARE_DEVELOPMENT_GUIDE.md)，`docs/` 下有文档索引。每次推送到 `main` 和拉取请求都会在 CI（`.github/workflows/build.yml`）中运行宿主逻辑测试与完整 ESP-IDF 构建。
