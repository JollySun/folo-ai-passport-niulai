...
- The device now enters deep sleep after 5 minutes of inactivity and wakes on a low-level GPIO0 button press.
- Added rendered screen captures of all four pages to the README.

### Changed

- Idle standby now suspends the LCD panel, the audio path, and the animation timer instead of only turning off the backlight.
- Extended the built-in font subsets with the 《》 glyphs used by the poster caption.
...
[Unreleased]: https://github.com/JollySun/folo-ai-passport-niulai/compare/v0.2.0...HEAD
[0.2.0]: https://github.com/JollySun/folo-ai-passport-niulai/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/JollySun/folo-ai-passport-niulai/compare/v0.0.2...v0.1.0
